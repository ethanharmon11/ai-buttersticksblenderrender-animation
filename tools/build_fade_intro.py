...
// out: opacity only, lining lingers a breath longer. No scale on the way
// out — moving the letterforms while they fade re-rasterizes their edges
// every frame, which reads as the mark shaking just as it leaves.
tl.addLabel("out", 4.0)
  .to("#wordmark", {{ autoAlpha: 0, duration: 0.9, ease: "sine.in" }}, "out")
